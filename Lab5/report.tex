...
\begin{figure}[H]
 ...
 \caption{External temperature and the corresponding thrust}
 % \label{q6}
\end{figure}
...
\begin{figure}[H]
 ...
 \caption{Residual plot for the external temperature variable}
 % \label{q6}
\end{figure}
The residuals appear randomly scattered about the horizontal 0 line.
Additionally, we observe that the Normal Probability plot below
...
\begin{figure}[H]
 ...
 \caption{Normal plot for the external temperature variable}
 % \label{q6}
\end{figure}
