...
\begin{equation}
 ...
 \label{model}
\end{equation}
, where $y$ is the thrust, and $x$ is the fuel flow rate. The model's assumptions
are as follows:
\begin{enumerate}
...
\todo{Are there any influential observations  in the sense that removing them would change the fitted line? Are there any outliers (large residuals)?}
...
\todo{idk where to find this. is it 189.466735? compare to average of what?}
