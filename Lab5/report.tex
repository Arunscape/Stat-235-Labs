...
\begin{itemize}
 ...
 \item The plot for ambtemp vs. thrust above does not appear to exhibit a strong linear
       relationship. It is possible that there is no relation between the ambient
       temperature and the thrust, or that there is a weak slightly negative linear
       relationship between the ambient temperature and thrust.
\end{itemize}
